...
export class IntegrityVerifier {
    ...
    private static checkNativeOverrides(): boolean {
        ...
        const nativeFunctions = [window.fetch, (window as any).XMLHttpRequest, window.MutationObserver];
    ...
    private static checkPrototypePollution(): boolean {
        ...
        return ({}).hasOwnProperty.call(Object.prototype, 'polluted') || ({} as any).polluted !== undefined;
    }
